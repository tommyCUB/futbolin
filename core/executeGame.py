...
query= "select idTeam1,idTeam2,idLiga,desicion,fecha,executor from plan where idPlan='"+str(idPlan)+"' limit 1"
...
query= "update executor set idPlan"+str(plan[0][5])+"='-1' where idExecutor='matador' limit 1"
cable.run_query(query)
