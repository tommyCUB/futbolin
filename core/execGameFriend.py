...
dir1= os.path.abspath("/home/futbol/public_html/codes/"+str(ids1)+".fer")
dir2= os.path.abspath("/home/futbol/public_html/codes/"+str(ids2)+".fer")
...
update.actualizarElos(ids1,ids2,winner,cable,3)
