...
<link rel="stylesheet" type="text/css" href="../css/show3.css">
<body>
 <script src="../js/show3.js"></script>		   
				<div class="centered" id="divTerreno3" onClick="tooglePlay()">	
				  ...
				  <?php
					...
					for($i=1;$i<=11;$i++)
						{
				  ?>
				   <div id='e1p<?php echo $i;?>' class='player3 d-inline-block' style="background:url(../images/tshirt/<?php echo $team1->tshirt;echo $i;?>.png) no-repeat; background-size:100% 100%;"><b style="position: absolute; text-align: center; bottom:-10px; font-size: 9px; color: black; width: 5px;"><?php echo $i;?></b>
					</div>
				   <div id='e2p<?php echo $i;?>' class='player3 d-inline-block' style="background:url(../images/tshirt/<?php echo $team2->selectTshirt($team1->tshirt);echo $i;?>.png)  no-repeat; background-size:100% 100%;"><b class="centered" style="position: absolute; bottom:-10px; font-size: 9px; color: white;"><?php echo $i;?></b></div>
				   <?php
						}
				   ?>  
